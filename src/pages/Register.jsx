...
import { Cpu, Mail, Lock, UserPlus, User, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-darkBg text-slate-100 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-slate-400 text-sm mt-1">Get instant AI-driven interview evaluations</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl shadow-glass border border-glass">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 mt-2 bg-brandPurple hover:bg-brandPurple/90 text-white font-bold rounded-xl shadow-glow-purple flex items-center justify-center space-x-2 transition-all duration-200 disabled:opacity-50 transform hover:-translate-y-0.5"
            >
              <span>{isSubmitting ? 'Registering Account...' : 'Get Started'}</span>
          ...
          <div className="mt-6 text-center text-sm text-slate-400">
            ...
            <Link to="/login" className="text-brandPurple hover:underline font-semibold flex items-center justify-center inline-flex space-x-1">
              <span>Sign In</span>
